...
**[Docs & live demo →](https://yantrakit.com/flowchart-react)** · **[GitHub](https://github.com/yantrakitinc/flowchart-react)**

> **v2 is a breaking rewrite of v1.** Upgrading? See [`MIGRATION.md`](https://github.com/yantrakitinc/flowchart-react/blob/main/MIGRATION.md).
> **Using this from an AI agent?** See [`AGENTS.md`](https://github.com/yantrakitinc/flowchart-react/blob/main/AGENTS.md) for the machine-facing contract.
