...
No central `docs/test-matrix/marker-audit.md` register. Cross-feature collision checks use grep; the per-feature spec.md documents the markers each feature owns.
