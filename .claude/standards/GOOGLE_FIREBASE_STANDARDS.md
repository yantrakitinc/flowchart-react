...
- `enforced_by`: scripts/verify/verify-firebase-boundary.mjs _(pnpm verify chain; client SDK imports, banned files, NEXT_PUBLIC_FIREBASE_*/secrets, email allowlists fail)_
