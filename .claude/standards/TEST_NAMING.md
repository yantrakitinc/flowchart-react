...
scripts/verify/verify-tests.mjs --check test-naming _(pnpm verify chain; __tests__/__stories__ filename shapes + e2e scenario/flow folder contract + variants[] file match)_
