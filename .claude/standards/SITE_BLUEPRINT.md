...
- `short_circuit_green`:
  - ui_discipline: none
  - no spec.yaml with `tier: page` found in the repo
...
- `blocked_action`: "starting or committing page-tier source (spec.yaml tier: page, or its co-located .tsx)"
- `preconditions`:
  - lock marker present in docs/site/00-INDEX.md
  - page spec.yaml carries blueprint_doc: path _(e.g. docs/site/pages/channel-queue.md)_
...
- `script`: scripts/verify/verify-site-blueprint.mjs
