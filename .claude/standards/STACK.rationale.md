...
- `SPEC_CONTRACT.md` + `FLOW_CONTRACT.md` + `MANUAL_FLOWS.md` + `AGENT_AFFORDANCES.md` — folder layout (`__specs__/spec.md`, `flows/`, `manual/`), `data-agent-*` attributes, action verbs.
