# DIGEST for coder.md — GENERATED, do not edit. Regenerate: node ~/.claude/standards/scripts/generate/generate-agent-digests.mjs
# sources:
#   STACK.md 8642c3bb226e89ca
#   TYPESCRIPT_HYGIENE.md f6251ebc91a7a7be
#   NAMING.md d1b0e4ffa6aad9e0
#   CODE_DOCUMENTATION.md 32d64d1f2b77de46
#   LOGGING.md 135c823231b6375d
#   DESIGN_TOKENS.md 9d96c39b580a93e0
#   UTC_TIMESTAMPS.md 56464f44694050c8
#   SOURCE_FOLDERS.md 8f5122866a39f9d5
#   HEXAGONAL_ARCHITECTURE.md 5cb59d8615a9a0db
#   UNIT_COVERAGE.md 6a7f81c15dd03bdb
...
- `agent_standards`: SPEC_CONTRACT.md + FLOW_CONTRACT.md + MANUAL_FLOWS.md + AGENT_AFFORDANCES.md # spec.yaml / flows / manual / data-* attributes
...
- `enforcement`: scripts/verify/verify-no-padding-folders.mjs refuses any sub-folder under src/features/<name>/ with zero .ts/.tsx files (except __specs__/, which holds YAML)
- `sub_folders`:
